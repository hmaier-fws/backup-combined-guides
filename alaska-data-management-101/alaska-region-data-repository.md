...
To obtain an archive folder for your project, complete a [Data Management Plan (DMP)](../plan/create-a-data-management-plan/data-management-plan-templates/) and submit it to your data manager.  The DMP is a working communication document between the project team and your data manager.&#x20;
...
![Example RDR digital location](<../.gitbook/assets/image (110).png>)

## How to use the Regional Data Repository
...
* **documents** include materials generated by the project; these products may also be described in metadata.  Some documents are internal work products and may not be intended for public consumption.  The contents of the documents folder may include:
  * [data management plan](../plan/create-a-data-management-plan/data-management-plan-templates/) for the project
